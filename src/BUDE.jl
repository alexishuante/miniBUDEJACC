...
struct Deck
  protein::AbstractArray{Atom} #Change to JACC.Array?
  ligand::AbstractArray{Atom} #Change to JACC.Array?
  forcefield::AbstractArray{FFParams} #Change to JACC.Array?
  poses::AbstractArray{Float32,2} #Change to JACC.Array?
end
...
function main()
  ...
  # println("Contents of current directory: ", readdir()),
  # println("Script location: ", @__FILE__),
